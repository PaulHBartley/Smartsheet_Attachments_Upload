...
- If a match is found between an .mp3 filename and a row's ID# in the "ItemID" cell, the .mp3 may be uploaded only if there is no existing .mp3 attachment for that row.
